...
/** @defgroup FLASH_Address Base address of the Flash sectors
  * @{
  */
...
uint32_t FLASH_GetSector(uint32_t Address); // returns the bit mask
uint32_t FLASH_GetSectorNumber(uint32_t Address); // returns the index from 0
